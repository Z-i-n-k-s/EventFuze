    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 py-20 px-4">
      <div className="max-w-5xl mx-auto" ref={sectionRef}>
        ...
        <div className={`text-center mb-12 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300">View all events you attended or registered for.</p>
        </div>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex-shrink-0">
                  {event.attended ? (
                    event.certificateDownloaded ? (
                      <div className="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-4 py-2 rounded-xl font-medium flex items-center gap-2 cursor-not-allowed">
                        <Download className="w-4 h-4"/> Certificate Downloaded
                      </div>
                    ) : (
                      <button
