...
const Adminpanel = () => {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-slate-900 dark:via-slate-800/30 dark:to-slate-900/40 overflow-hidden">
            ...
            <AnimatePresence>
              {isOpen && (
                ...
                >
                  ...
                  <span className="text-xs mt-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-green-500 to-green-600 text-white font-medium shadow-sm">
                    {user?.role}
                  </span>
                </motion.div>
              )}
          ...
          <AnimatePresence>
            {isOpen ? (
              ...
              >
                ...
                <div className="mt-1 h-1 bg-gradient-to-r from-green-500 to-green-600 rounded-full mx-auto w-16"></div>
              </motion.div>
            ) : (
              <motion.div
                initial={{ opacity: 0 }}
      ...
      >
        <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm shadow-xl rounded-3xl p-8 min-h-full border border-white/20 dark:border-slate-700/50 relative overflow-hidden">
